...
export const EditUserProfile = () => {
  ...
  const id: string = getProfile.data.getCurrentUserProfile.id;
  ...
  const [createProfile, profileResult] = useMutation(updateProfileM, {
    variables: {
  ...
  return (
    <form
      ...
      style={{
        ...
        background: `linear-gradient(180deg, ${profile.color} -130%, rgba(247, 237, 238, 0) 100%)`,
      }}
    >
