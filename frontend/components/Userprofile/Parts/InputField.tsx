  ...
  return (
    <div>
      ...
      {search ? (
        <>
          {' '}
          <div className="absolute flex flex-col justify-start items-start overflow-y-scroll overflow-x-hidden text-sm antialiased font-base text-white italic bg-gray-700 rounded-bl-md rounded-tl-md outline-none w-[16.5rem] h-[15rem] py-1 px-1 mt-[-0.75rem]">
            {props.version === 'anime' ? (
              <>
