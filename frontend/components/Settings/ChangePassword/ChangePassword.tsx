    ...
    <>
      ...
      >
        <h1 className="text-xs text-white w-64 text-center mb-3">
          If you would like to change your password type your current password
          in here:
        </h1>
        <input
          onChange={onChange}
          ...
          name="oldPassword"
          type="password"
          className="text-sm italic antialiased font-base text-black bg-white rounded-lg outline-none w-64 h-[2.25rem]  px-4  mb-1"
        />
        {error || zodError ? (
          <>
            {error ? (
        ...
        <button
          type="submit"
          className="btn text-white bg-indigo-600 hover:bg-indigo-700 w-64 mt-1"
        >
          Change Password
        </button>
        {success ? (
